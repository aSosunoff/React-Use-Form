...
function index_slicedToArray(arr, i) { return index_arrayWithHoles(arr) || index_iterableToArrayLimit(arr, i) || index_unsupportedIterableToArray(arr, i) || index_nonIterableRest(); }

function index_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
...
function index_iterableToArrayLimit(arr, i) { if (typeof Symbol === "undefined" || !(Symbol.iterator in Object(arr))) return; var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"] != null) _i["return"](); } finally { if (_d) throw _e; } } return _arr; }

function index_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
var useForm = function useForm() {
  ...
  var values = (0,external_react_.useMemo)(function () {
    return reduceConfigTransform(form, function (_ref) {
      var value = _ref.value;
      return value;
    });
  }, [form]);
  var setValue = (0,external_react_.useCallback)(function (key, value, touched) {
    if (_typeof(key) === "object") {
      setForm(function (prev) {
        return reduceConfigTransform(prev, function (config, field) {
          var _touched2, _value2;
  ...
  var onChange = (0,external_react_.useCallback)(function (key) {
    return function (ev) {
      setValue(key, ev.target ? ev.target.value : ev, true);
    };
  }, [setValue]);
  var handlers = (0,external_react_.useMemo)(function () {
    return reduceConfigTransform(form, function (config, key) {
      return index_objectSpread(index_objectSpread({}, config), {}, {
